...
2. Primeiro vamos fazer o fork do repositório que contém os exercícios da disciplina. Acesse o link [FIAP-Microservices-Serverless](https://github.com/vamperst/FIAP-Microservices-Serverless/tree/master)
